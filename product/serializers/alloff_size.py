...
class AlloffSizeSerializer(proto_serializers.ProtoSerializer):
    ...
    guide_image = serializers.CharField()
...
class EditAlloffSizeSerializer(proto_serializers.ProtoSerializer):
    alloff_size_id = serializers.CharField()
    size_name = serializers.CharField(allow_null=True, allow_blank=True, required=False)
    guide_image = serializers.CharField(allow_null=True, allow_blank=True, required=False)
