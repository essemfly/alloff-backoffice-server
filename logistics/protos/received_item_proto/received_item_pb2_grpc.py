...
class ReceivedItemControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.List = channel.unary_unary(
                ...
                response_deserializer=logistics_dot_protos_dot_received__item__proto_dot_received__item__pb2.ReceivedItemListResponse.FromString,
                )
        ...
        self.Make = channel.unary_stream(
                ...
                request_serializer=logistics_dot_protos_dot_received__item__proto_dot_received__item__pb2.MakeReceivedItemRequest.SerializeToString,
                response_deserializer=logistics_dot_protos_dot_received__item__proto_dot_received__item__pb2.ReceivedItem.FromString,
                )
...
def add_ReceivedItemControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'List': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=logistics_dot_protos_dot_received__item__proto_dot_received__item__pb2.ReceivedItemListResponse.SerializeToString,
            ),
            ...
            'Make': grpc.unary_stream_rpc_method_handler(
                    servicer.Make,
                    request_deserializer=logistics_dot_protos_dot_received__item__proto_dot_received__item__pb2.MakeReceivedItemRequest.FromString,
                    response_serializer=logistics_dot_protos_dot_received__item__proto_dot_received__item__pb2.ReceivedItem.SerializeToString,
            ),
...
class ReceivedItemController(object):
    ...
    def List(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/received_item.ReceivedItemController/List',
            ...
            logistics_dot_protos_dot_received__item__proto_dot_received__item__pb2.ReceivedItemListResponse.FromString,
    ...
    def Make(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/received_item.ReceivedItemController/Make',
            logistics_dot_protos_dot_received__item__proto_dot_received__item__pb2.MakeReceivedItemRequest.SerializeToString,
            logistics_dot_protos_dot_received__item__proto_dot_received__item__pb2.ReceivedItem.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
