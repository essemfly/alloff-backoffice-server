...
_ORDERITEMEXCELDATAREQUEST = _descriptor.Descriptor(
  name='OrderItemExcelDataRequest',
  full_name='orderitem.OrderItemExcelDataRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='company_keyname', full_name='orderitem.OrderItemExcelDataRequest.company_keyname', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='date_from', full_name='orderitem.OrderItemExcelDataRequest.date_from', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='date_to', full_name='orderitem.OrderItemExcelDataRequest.date_to', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['OrderItemExcelDataRequest'] = _ORDERITEMEXCELDATAREQUEST
...
_ORDERITEMCONTROLLER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetOrderItemExcelData',
    full_name='orderitem.OrderItemController.GetOrderItemExcelData',
    index=12,
    containing_service=None,
    input_type=_ORDERITEMEXCELDATAREQUEST,
    output_type=_ORDERITEM,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
