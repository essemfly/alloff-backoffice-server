...
def add_ProductServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListProducts': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=protos_dot_product_dot_product__pb2.ListProductsRequest.FromString,
                    response_serializer=protos_dot_product_dot_product__pb2.ListProductsResponse.SerializeToString,
            ),
            'CreateProduct': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateProduct,
                    request_deserializer=protos_dot_product_dot_product__pb2.CreateProductRequest.FromString,
                    response_serializer=protos_dot_product_dot_product__pb2.CreateProductResponse.SerializeToString,
            ),
            'EditProduct': grpc.unary_unary_rpc_method_handler(
                    servicer.EditProduct,
                    request_deserializer=protos_dot_product_dot_product__pb2.EditProductRequest.FromString,
                    response_serializer=protos_dot_product_dot_product__pb2.EditProductResponse.SerializeToString,
            ),
    }
