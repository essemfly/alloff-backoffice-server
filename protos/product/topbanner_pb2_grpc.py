...
from protos.product import topbanner_pb2 as protos_dot_product_dot_topbanner__pb2
...
def add_TopBannerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetTopBanner': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=protos_dot_product_dot_topbanner__pb2.GetTopBannerRequest.FromString,
                    response_serializer=protos_dot_product_dot_topbanner__pb2.GetTopBannerResponse.SerializeToString,
            ),
            'ListTopBanners': grpc.unary_unary_rpc_method_handler(
                    servicer.ListTopBanners,
                    request_deserializer=protos_dot_product_dot_topbanner__pb2.ListTopBannersRequest.FromString,
                    response_serializer=protos_dot_product_dot_topbanner__pb2.ListTopBannersResponse.SerializeToString,
            ),
            'EditTopBanner': grpc.unary_unary_rpc_method_handler(
                    servicer.EditTopBanner,
                    request_deserializer=protos_dot_product_dot_topbanner__pb2.EditTopBannerRequest.FromString,
                    response_serializer=protos_dot_product_dot_topbanner__pb2.EditTopBannerResponse.SerializeToString,
            ),
            'CreateTopBanner': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateTopBanner,
                    request_deserializer=protos_dot_product_dot_topbanner__pb2.CreateTopBannerRequest.FromString,
                    response_serializer=protos_dot_product_dot_topbanner__pb2.CreateTopBannerResponse.SerializeToString,
            ),
    }
