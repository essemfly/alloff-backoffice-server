...
# source: protos/logistics/courier/courier.proto
...
Courier = _reflection.GeneratedProtocolMessageType('Courier', (_message.Message,), {
  'DESCRIPTOR' : _COURIER,
  '__module__' : 'protos.logistics.courier.courier_pb2'
