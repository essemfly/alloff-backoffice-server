...
from protos.logistics.received_item import received_item_pb2 as protos_dot_logistics_dot_received__item_dot_received__item__pb2
...
class ReceivedItemControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.List = channel.unary_unary(
                ...
                request_serializer=protos_dot_logistics_dot_received__item_dot_received__item__pb2.ReceivedItemListRequest.SerializeToString,
                response_deserializer=protos_dot_logistics_dot_received__item_dot_received__item__pb2.ReceivedItemListResponse.FromString,
                )
...
def add_ReceivedItemControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'List': grpc.unary_unary_rpc_method_handler(
                    servicer.List,
                    request_deserializer=protos_dot_logistics_dot_received__item_dot_received__item__pb2.ReceivedItemListRequest.FromString,
                    response_serializer=protos_dot_logistics_dot_received__item_dot_received__item__pb2.ReceivedItemListResponse.SerializeToString,
            ),
...
class ReceivedItemController(object):
    ...
    def List(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/received_item.ReceivedItemController/List',
            protos_dot_logistics_dot_received__item_dot_received__item__pb2.ReceivedItemListRequest.SerializeToString,
            protos_dot_logistics_dot_received__item_dot_received__item__pb2.ReceivedItemListResponse.FromString,
    ...
    def Create(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/received_item.ReceivedItemController/Create',
            protos_dot_logistics_dot_received__item_dot_received__item__pb2.ReceivedItem.SerializeToString,
