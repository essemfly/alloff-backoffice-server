...
_COURIER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="courier.Courier.name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="courier.Courier.sweettracker_id",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="courier.Courier.tracking_url_base",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="_tracking_url_base",
            full_name="courier.Courier._tracking_url_base",
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
_COURIERRETRIEVEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="courier.CourierRetrieveRequest.id",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
...
_COURIER.fields_by_name["tracking_url_base"].containing_oneof = _COURIER.oneofs_by_name[
    "_tracking_url_base"
]
...
Courier = _reflection.GeneratedProtocolMessageType(
    "Courier",
    (_message.Message,),
    {
        "DESCRIPTOR": _COURIER,
...
CourierListRequest = _reflection.GeneratedProtocolMessageType(
    "CourierListRequest",
    (_message.Message,),
    {
...
CourierRetrieveRequest = _reflection.GeneratedProtocolMessageType(
    "CourierRetrieveRequest",
    (_message.Message,),
    {
