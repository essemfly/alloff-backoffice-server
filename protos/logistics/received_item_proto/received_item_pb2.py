...
_RECEIVEDITEM_RECEIVEDITEMSTATUS = _descriptor.EnumDescriptor(
    name="ReceivedItemStatus",
    full_name="received_item.ReceivedItem.ReceivedItemStatus",
    filename=None,
    file=DESCRIPTOR,
    create_key=_descriptor._internal_create_key,
    values=[
        _descriptor.EnumValueDescriptor(
            name="SOURCING_REQUIRED",
            index=0,
            number=0,
            serialized_options=None,
            type=None,
...
_RECEIVEDITEM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="received_item.ReceivedItem.id",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="code",
            full_name="received_item.ReceivedItem.code",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="status",
            full_name="received_item.ReceivedItem.status",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="product_id",
            full_name="received_item.ReceivedItem.product_id",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="product_name",
            full_name="received_item.ReceivedItem.product_name",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="received_item.ReceivedItem.product_brand_id",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="received_item.ReceivedItem.product_brand_name",
            index=6,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="product_size",
            full_name="received_item.ReceivedItem.product_size",
            index=7,
            number=8,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="product_color",
            full_name="received_item.ReceivedItem.product_color",
            index=8,
            number=9,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="created_at",
            full_name="received_item.ReceivedItem.created_at",
            index=9,
            number=10,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="updated_at",
            full_name="received_item.ReceivedItem.updated_at",
            index=10,
            number=11,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="deleted_at",
            full_name="received_item.ReceivedItem.deleted_at",
            index=11,
            number=12,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="inventory",
            full_name="received_item.ReceivedItem.inventory",
            index=12,
            number=13,
            type=11,
            cpp_type=10,
    ...
    nested_types=[],
    enum_types=[
        _RECEIVEDITEM_RECEIVEDITEMSTATUS,
    ],
    serialized_options=None,
    is_extendable=False,
    syntax="proto3",
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="_inventory",
            full_name="received_item.ReceivedItem._inventory",
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
_RECEIVEDITEMRETRIEVEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="received_item.ReceivedItemRetrieveRequest.id",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
...
_RECEIVEDITEM.fields_by_name[
    "inventory"
].containing_oneof = _RECEIVEDITEM.oneofs_by_name["_inventory"]
...
DESCRIPTOR.message_types_by_name[
    "ReceivedItemRetrieveRequest"
] = _RECEIVEDITEMRETRIEVEREQUEST
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

ReceivedItem = _reflection.GeneratedProtocolMessageType(
    "ReceivedItem",
    (_message.Message,),
    {
        "DESCRIPTOR": _RECEIVEDITEM,
        "__module__": "protos.logistics.received_item_proto.received_item_pb2"
        # @@protoc_insertion_point(class_scope:received_item.ReceivedItem)
    },
)
_sym_db.RegisterMessage(ReceivedItem)

ReceivedItemListRequest = _reflection.GeneratedProtocolMessageType(
    "ReceivedItemListRequest",
    (_message.Message,),
    {
...
ReceivedItemRetrieveRequest = _reflection.GeneratedProtocolMessageType(
    "ReceivedItemRetrieveRequest",
    (_message.Message,),
    {
