...
class ShippingNoticeControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.List = channel.unary_unary(
                ...
                request_serializer=protos_dot_logistics_dot_shipping__notice_dot_shipping__notice__pb2.ShippingNoticeListRequest.SerializeToString,
                response_deserializer=protos_dot_logistics_dot_shipping__notice_dot_shipping__notice__pb2.ShippingNoticeListResponse.FromString,
                )
...
def add_ShippingNoticeControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'List': grpc.unary_unary_rpc_method_handler(
                    servicer.List,
                    request_deserializer=protos_dot_logistics_dot_shipping__notice_dot_shipping__notice__pb2.ShippingNoticeListRequest.FromString,
                    response_serializer=protos_dot_logistics_dot_shipping__notice_dot_shipping__notice__pb2.ShippingNoticeListResponse.SerializeToString,
            ),
...
class ShippingNoticeController(object):
    ...
    def List(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/shipping_notice.ShippingNoticeController/List',
            protos_dot_logistics_dot_shipping__notice_dot_shipping__notice__pb2.ShippingNoticeListRequest.SerializeToString,
            protos_dot_logistics_dot_shipping__notice_dot_shipping__notice__pb2.ShippingNoticeListResponse.FromString,
